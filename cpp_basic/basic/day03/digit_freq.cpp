...
int main() {
    ...
    for (int i = 0; i < len; ++i) {
        switch (str[i] - '0') {
            case 0: req_arr[0]++; break;
            case 1: req_arr[1]++; break;
            case 2: req_arr[2]++; break;
            case 3: req_arr[3]++; break;
            case 4: req_arr[4]++; break;
            case 5: req_arr[5]++; break;
            case 6: req_arr[6]++; break;
            case 7: req_arr[7]++; break;
            case 8: req_arr[8]++; break;
            case 9: req_arr[9]++; break;
            default: break;
        }
    }
