...
int main() {
    std::string text = "opencv c++ imaging"; // 要编码的内容
    ...
    // 4. 保存二维码
    cv::imwrite("opencv_qrcode.png", qr_img);
    std::cout << "QR code saved as opencv_qrcode.png" << std::endl;
